Cohorts = (function() {
    ...
    var Tests = (function() {
        function replayAll() {
            Utils.log('Replaying all tests...');
            for (var i=0, l=testInstances.length; i<l; i++) {
                testInstances[i].run();
            }
        }
    ...
    var Test = (function() {
        ...
        constructor.prototype = {
            run: function() {
                Utils.log('Running test "' + this.options.name + '"');
            ...
            setCohort: function(cohort) {
                for(var i=0, l=this.cohorts.length; i<l; i++){
                ...
                return false;
                /* Array.prototype.indexOf is not defined in IE8
...
=======
>>>>>>> b7c1cca69af0a4f4151759d380bc733768e4e895
